...
# Schematic BOM Export (Codex adapter)
...
Keep this file as a Codex-specific thin adapter: frontmatter, trigger wording, and Codex-only metadata belong here; durable BOM rules, layout constants, scripts, and reusable lessons belong in the shared base.
