...
| --- | --- | --- |
| nonvolatile (phase shifter, memory, material) | нелетучий фазовращатель | энергонезависимый фазовращатель. «Нелетучий» в русском означает «не испаряющийся» и уводит читателя в химию; для устройств и памяти установлено «энергонезависимый». Проверять по русскоязычным переводам первоисточников: в конспекте Gosciniak 2022 в вауте стоит именно «энергонезависимые» (поймано 28.08.2026 — калька дошла до собранного DOCX, потому что языковой проход был пропущен) |
| butt joint / butt coupling | стык встык (тавтология) | стыковое соединение; «поставленные встык» как наречие допустимо |
