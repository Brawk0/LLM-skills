...
Отсюда граница приёма:

- **Помогает** там, где широкое действие стоит В ОДНОМ такте с другими
  действиями: вынести его в свой такт — чистый выигрыш, число регистров растёт
  чуть-чуть.
- **Вредит** там, где такт уже занят одним-единственным действием, а ступеней
  много (конвейерный делитель — двадцать одинаковых ступеней). Тут добавление
  регистров только растаскивает размещение.

Проверять надо замером, а не рассуждением: приём и его противоположность дают
на одном кристалле противоположный знак, и предсказать заранее не выходит.
Откат — нормальный исход попытки.
